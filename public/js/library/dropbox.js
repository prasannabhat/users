...
(function() {
  var Dropbox, DropboxClient, DropboxXhrCanSendForms, DropboxXhrDoesPreflight, DropboxXhrIeMode, DropboxXhrRequest, add32, arrayToBase64, atob, atobNibble, base64Digits, base64HmacSha1, base64Sha1, btoa, btoaNibble, crypto, dropboxEncodeKey, hmacSha1, rotateLeft32, sha1, stringToArray, _base64Digits,
  ...
  Dropbox.Client = (function() {
    ...
    Client.prototype.readFile = function(path, options, callback) {
      var modifiedSinceHeader, params, rangeEnd, rangeHeader, rangeStart, responseType, xhr;
  ...
  */
  ...
  Dropbox.Xhr = (function() {
    ...
    Xhr.prototype.setBody = function(body) {
      ...
      if (!this.preflight) {
        if (!((typeof FormData !== "undefined" && FormData !== null) && body instanceof FormData)) {
          this.preflight = true;
        }
      }
      this.body = body;
